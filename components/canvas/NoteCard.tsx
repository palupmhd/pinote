  ...
  return (
    <div
      ...
      style={{
        left: element.x,
        top: element.y,
        // +2*CARD_GUTTER: kotak posisi sengaja lebih lebar dari ukuran logis
        // supaya permukaan bermargin di dalamnya menyusut pas balik ke
        // element.width (kelipatan grid) — lihat komentar CARD_GUTTER.
